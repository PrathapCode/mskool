...
import 'package:m_skool_flutter/manager/staff_birthday/api/staff_bday_report_api.dart';
import 'package:m_skool_flutter/manager/staff_birthday/controller/bday_controller.dart';
import 'package:m_skool_flutter/manager/staff_birthday/widget/bday_item.dart';
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await StudentBdayReportApi.instance.getBday(
          ...
          base: baseUrlFromInsCode("birthday", widget.mskoolController),
          type: 0,
            ...
            child: DropdownButtonFormField<Map<String, dynamic>>(
              ...
              onChanged: (value) {
                ...
                StudentBdayReportApi.instance.getBday(
                    ...
                    base:
                        baseUrlFromInsCode("birthday", widget.mskoolController),
                    type: 0,
                    bdayController: bdayController);
                //setState(() {});
